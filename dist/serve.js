...
/***/ function(module, exports, __webpack_require__) {
	...
	var template = _lodash2['default'].template(_fs2['default'].readFileSync('dist/index.html', 'utf8'));

	server.set('port', process.env.PORT || 3000);
	server.use(_express2['default']['static']('./dist/public'));
	server.use(_express2['default']['static']('./dist/public/js'));
	server.use('/commonjs', _express2['default']['static']('./public/js/common'));

	server.get('*', function (req, res, next) {
	  if (/.*public.*\.[a-z\d]+/i.test(req.path)) return next();
	  ...
	  (0, _reactRouter.match)({ routes: _routes2['default'], location: req.url }, function (error, redirectLocation, renderProps) {
	    if (error) {
	      ...
	      res.status(200).send(template({
	        ...
	        body: _reactDomServer2['default'].renderToString(_react2['default'].createElement(_reactRouter.RoutingContext, renderProps))
	      }));
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClientReactRootIndex = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createBrowserHistory = typeof document == 'object' ? __webpack_require__(157) : function () {
	  return {};
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DOMStateStorage = __webpack_require__(162);
